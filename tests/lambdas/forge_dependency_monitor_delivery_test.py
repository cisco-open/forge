"""Splunk delivery tests for the Forge dependency-monitor Lambda."""
...
def _load_common(monkeypatch, **environment):
    ...
    spec = importlib.util.spec_from_file_location(
        'forge_dependency_monitor_delivery_under_test',
...
def test_client_error_is_not_retried(monkeypatch, aws):
    ...
    assert 'status 400' in str(raised.value.__cause__)
