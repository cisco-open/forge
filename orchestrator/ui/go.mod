module github.com/cisco-open/forge/orchestrator/ui

go 1.24.3

require github.com/cisco-open/forge/orchestrator/internal v0.0.0
...
replace github.com/cisco-open/forge/orchestrator/internal => ../internal
