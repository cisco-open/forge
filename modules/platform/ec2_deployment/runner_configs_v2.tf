locals {
  ...
  multi_runner_config = {
    ...
    key => merge(runner_config, {
      runner = merge(runner_config.runner, {
        ...
        iam = merge(runner_config.runner.iam, {
          managed_policy_arns = merge(
            runner_config.runner.iam.managed_policy_arns,
      ...
      ssm = merge(runner_config.ssm, {
        kms_key = runner_config.ssm.kms_key == null ? {
          arn = aws_kms_key.github.arn
        } : runner_config.ssm.kms_key
      })
    })
  }
}
