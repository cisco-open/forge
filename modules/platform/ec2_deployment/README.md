...
| <a name="output_microvm_runners_map"></a> [microvm\_runners\_map](#output\_microvm\_runners\_map) | Map of Lambda MicroVM runner keys to their provider-owned image and execution-role outputs. |
