...
| <a name="input_log_level"></a> [log\_level](#input\_log\_level) | Log level for runner pod init commands (e.g., INFO, DEBUG, WARN, ERROR). When set to DEBUG, init container commands run in verbose mode. | `string` | `"INFO"` | no |
