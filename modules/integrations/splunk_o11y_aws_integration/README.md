...
- Metric Stream tag management requires Python 3.12, the AWS CLI, and `cloudwatch:ListMetricStreams`, `cloudwatch:TagResource`, and `cloudwatch:UntagResource` permissions for the configured AWS profile.
