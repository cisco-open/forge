...
| <a name="input_tenant_pods_pending_notifications"></a> [tenant\_pods\_pending\_notifications](#input\_tenant\_pods\_pending\_notifications) | Optional notification override for the standalone tenant pending-pod detector. | `list(string)` | `null` | no |
