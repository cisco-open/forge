...
| `Forge ARC Runner Operations` | ARC controller/listener health, runner supply, job throughput, latency, and workflow fingerprints | `dashboard_variables.runner_k8s` |
...
- `Forge ARC Runner Operations` requires ARC controller and listener
  ...
  histogram export from the Splunk OpenTelemetry Collector.
