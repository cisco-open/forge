...
| `modules/integrations/forge_dependency_monitor`                   | Regional GitHub and AWS dependency probes.              | No        | `examples/deployments/integrations` | Regional HEC events and O11y metrics are received. |
